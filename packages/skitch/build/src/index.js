(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "./cmds/add", "./cmds/bundle", "./cmds/createdb", "./cmds/dropdb", "./cmds/deploy", "./cmds/generate", "./cmds/init", "./cmds/plan", "./cmds/rename", "./cmds/revert", "./cmds/start", "./cmds/test", "./cmds/verify"], factory);
    }
    ...
    exports.default = {
        add: add_1.default,
        bundle: bundle_1.default,
        createdb: createdb_1.default,
        dropdb: dropdb_1.default,
