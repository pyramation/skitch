...
describe('resolve', function () {
    it('throws an error if file not found', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, resolve_1.resolve(__dirname + '/fixtures/error-case')];
                case 2:
                    _a.sent();
                    return [3 /*break*/, 4];
                case 3:
    ...
    it('throws an error if circular reference found', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, resolve_1.resolve(__dirname + '/fixtures/circular')];
                case 2:
                    _a.sent();
                    return [3 /*break*/, 4];
                case 3:
    ...
    it('throws an error if invalid sql found', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, resolve_1.resolve(__dirname + '/fixtures/invalid')];
                case 2:
                    _a.sent();
                    return [3 /*break*/, 4];
                case 3:
    ...
    it('resolves sql in proper order', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, resolve_1.resolve(__dirname + '/fixtures/basic')];
                case 1:
                    sql = _a.sent();
