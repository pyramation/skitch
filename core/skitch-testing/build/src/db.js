...
function dropdb(_a) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, asyncExec("dropdb -U " + user + " -h " + host + " -p " + port + " " + database, {
                        env: {
                            PGPASSWORD: password
                        }
                    })];
...
function createdb(_a) {
    var database = _a.database, host = _a.host, password = _a.password, port = _a.port, user = _a.user;
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, asyncExec("createdb -U " + user + " -h " + host + " -p " + port + " " + database, {
                        env: {
                            PGPASSWORD: password
                        }
                    })];
...
function templatedb(_a) {
    var database = _a.database, host = _a.host, password = _a.password, port = _a.port, template = _a.template, user = _a.user;
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, asyncExec("createdb -U " + user + " -h " + host + " -p " + port + " -e " + database + " -T " + template, {
                        env: {
                            PGPASSWORD: password
                        }
                    })];
