        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    sql = "UPDATE pg_database SET datistemplate = TRUE, datallowconn = FALSE WHERE datname = '" + template + "'";
                    return [4 /*yield*/, streamSql(config, sql)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
