...
var TestDatabase = /** @class */ (function () {
    ...
    TestDatabase.prototype.getConnection = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, testing_1.getConnection(__assign({}, this.config, { template: this.templateConfig.database }))];
                    case 1:
                        db = _a.sent();
                        // this.dbs.push(db);
                        return [2 /*return*/, db];
    ...
    TestDatabase.prototype.close = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, db_1.dropdb(this.templateConfig)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
