...
var extensions_1 = require("../src/extensions");
...
describe('extensions', function () {
    ...
    describe('skitch extensions', function () {
        it('list', function () { return __awaiter(_this, void 0, void 0, function () {
            var avail, installed;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, extensions_1.getAvailableExtensions()];
                    case 1:
                        avail = _a.sent();
                        return [4 /*yield*/, extensions_1.getInstalledExtensions()];
                    case 2:
                        installed = _a.sent();
                        expect(avail).toEqual(['plpgsql', 'uuid-ossp', 'pgcrypto', 'plv8', 'myproject']);
        ...
        it('write', function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, extensions_1.writeExtensions(['plpgsql', 'uuid-ossp', 'pgcrypto', 'plv8'])];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, extensions_1.getInstalledExtensions()];
                    case 2:
                    ...
                    case 3:
                        info = _a.sent();
                        expect(fs_1.readFileSync(info.controlFile).toString()).toMatchSnapshot();
                        return [2 /*return*/];
                }
            });
        }); });
