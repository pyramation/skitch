...
var random_1 = require("../src/random");
var glob_1 = require("glob");
describe('publish', function () {
    var dir, projDir;
    beforeEach(function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            dir = TMPDIR + '/' + random_1.random();
    ...
    it('publish an extension', function () { return __awaiter(_this, void 0, void 0, function () {
        var filesBefore, filesAfter;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    filesBefore = glob_1.sync('**');
                    expect(filesBefore).toMatchSnapshot();
                    return [4 /*yield*/, publish_1.publish('secrets', 'minor')];
                case 1:
                    _a.sent();
