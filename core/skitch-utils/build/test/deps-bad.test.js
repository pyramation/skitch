    ...
    it('sqitch package dependencies', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, deps_1.getDeps(__dirname + '/fixtures/broken/packages/secrets', 'secrets')];
                case 2:
                    res = _a.sent();
                    return [3 /*break*/, 4];
                case 3:
                    e_1 = _a.sent();
                    failed = true;
                    expect(e_1.message).toMatchSnapshot();
                    return [3 /*break*/, 4];
                case 4:
...
//# sourceMappingURL=deps-bad.test.js.map